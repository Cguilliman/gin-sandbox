...
func TestNewValidatorError(t *testing.T) {
	...
	r.POST("/login", func(c *gin.Context) {
		...
		if err := Bind(c, &json); err == nil {
			if json.Username == "cguilliman" && json.Password == "0123456789" {
